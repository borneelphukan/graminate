...
const PoultryDetailScreen = () => {
  ...
  const handleManageHealthRecordsClick = () =>
    router.push(`/${user_id}/poultry/poultry-health?flock_id=${id}`);
  const handleManageFeedRecordsClick = () =>
    router.push(`/${user_id}/poultry/poultry-feeds?flock_id=${id}`);
  const handleManageEggRecordsClick = () =>
    router.push(`/${user_id}/poultry/poultry-eggs?flock_id=${id}`);
