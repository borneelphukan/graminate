...
export default function Technology() {
  ...
  return (
    <DefaultLayout>
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-slate-950 pt-24 pb-16">
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20 relative z-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              >
                <span className="inline-flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/20 rounded-full px-4 py-1.5 text-emerald-400 text-xs font-black tracking-[0.2em] uppercase mb-6">
                  <span className="size-2 rounded-full bg-emerald-500 animate-pulse"></span>
                  Graminate Stack
                </span>
                <h1 className="text-3xl md:text-5xl font-black text-white tracking-tight leading-[0.95] text-balance mb-6">
                  The Advanced OS for <span className="text-emerald-400 font-medium">Precision</span> Agriculture in India.
                </h1>
              ...
              >
                <Button 
                  ...
                  variant="primary"
                  className="h-14 px-8 rounded-full !font-bold shadow-xl shadow-emerald-900/30"
            ...
            <div className="lg:col-span-5 relative flex justify-center">
              <div className="relative w-full max-w-[500px]">
                <img 
                  ...
                  className="w-full h-auto rounded-[2rem] border border-white/10 bg-slate-900/40 shadow-2xl block"
                />
              </div>
            </div>
      ...
      <section className="py-24 md:py-36 bg-slate-900 relative">
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          
          <motion.div {...fadeInUp} className="max-w-3xl mb-20">
            <span className="text-emerald-500 uppercase font-black tracking-[0.2em] text-xs mb-4 block">Capabilities</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="bg-slate-950 border border-white/5 rounded-3xl p-8 shadow-xl group hover:border-emerald-500/20 transition-all duration-300"
              >
                <div className="size-12 rounded-2xl bg-emerald-500/10 flex items-center justify-center text-emerald-400 group-hover:bg-emerald-500 group-hover:text-white transition-colors mb-6">
                  <Icon type={feature.icon} className="!text-[24px] flex items-center justify-center" />
                </div>
                <h3 className="text-xl font-bold text-white mb-3 tracking-tight">{feature.title}</h3>
                <p className="text-slate-400 font-light leading-relaxed text-base">{feature.desc}</p>
              </motion.div>
            ))}
          </div>
      ...
      <section className="py-24 md:py-36 bg-slate-950 text-white relative overflow-hidden">
        <div className="container mx-auto px-6 md:px-12 lg:px-20 relative z-10">
          ...
          <motion.div {...fadeInUp} className="text-center max-w-3xl mx-auto mb-24">
            <span className="text-emerald-400 uppercase font-black tracking-[0.2em] text-xs mb-4 block">Logic Pipeline</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
            ...
            <div className="hidden lg:block absolute top-16 left-[8%] right-[8%] h-[2px] bg-gradient-to-r from-emerald-900 via-emerald-500 to-emerald-900 opacity-30"></div>
            ...
            {[
              ...
              >
                ...
                <div className="relative size-32 rounded-full bg-slate-900 border-2 border-slate-800 grid place-items-center shadow-2xl shadow-emerald-900/10 mb-8 group-hover:border-emerald-500 transition-colors duration-500 relative z-10">
                  <div className="absolute -top-2 -left-2 bg-emerald-500 text-slate-950 font-black text-xs tracking-widest rounded-full px-3 py-1">
                    STAGE {stage.step}
                  </div>
                  <Icon type={stage.icon} className="!text-[44px] text-emerald-400 flex items-center justify-center" />
                </div>
                
                <h3 className="text-2xl font-black text-white mb-4 tracking-tight">{stage.title}</h3>
                <p className="text-slate-400 font-light leading-relaxed max-w-sm">{stage.desc}</p>
              </motion.div>
            ))}
          </div>
      ...
      <section className="py-24 md:py-40 bg-slate-900 overflow-hidden relative">
        ...
        <div className="absolute -bottom-48 -left-48 size-[600px] bg-emerald-500/5 blur-[100px] rounded-full"></div>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-6 space-y-8 order-2 lg:order-1">
              <motion.div {...fadeInUp}>
                <span className="text-emerald-500 font-black uppercase tracking-[0.2em] text-xs mb-4 block">For your Smartphone</span>
                <h2 className="text-2xl md:text-4xl font-bold text-white tracking-tight leading-[1.05] mb-6">
                  Graminate Mobile.<br />
                  <span className="text-emerald-400 font-medium">Field-Ready</span> Operations.
                </h2>
                <p className="text-slate-400 text-lg font-light leading-relaxed">
              ...
              >
                ...
                <a 
                  href="#" 
                  className="flex items-center gap-3.5 bg-slate-950 hover:bg-slate-900 border border-white/10 hover:border-emerald-500/30 transition-all duration-300 px-6 py-3.5 rounded-2xl group select-none shadow-xl"
                  onClick={(e) => e.preventDefault()}
                >
                  <svg className="size-7 fill-white group-hover:text-emerald-400 transition-colors" viewBox="0 0 384 512">
                  ...
                  <div className="text-left">
                    <span className="block text-[10px] font-extrabold text-slate-500 uppercase tracking-[0.15em] leading-none mb-1.5">Download for</span>
                ...
                <a 
                  ...
                  onClick={(e) => e.preventDefault()}
                >
                  <svg className="size-7 fill-white group-hover:text-emerald-400 transition-colors" viewBox="0 0 512 512">
            ...
            <div className="lg:col-span-6 flex justify-center order-1 lg:order-2 relative">
              ...
              <div className="absolute inset-0 size-[300px] bg-emerald-500/20 blur-[80px] rounded-full m-auto animate-pulse"></div>
              ...
              <motion.div
                ...
                className="relative w-full max-w-[320px] h-[640px] rounded-[3rem] bg-slate-950 border-[12px] border-slate-800 p-3 shadow-2xl overflow-hidden ring-1 ring-white/10"
              >
                {/* Phone Camera Notch */}
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-28 h-6 bg-slate-800 rounded-b-2xl z-30"></div>
                
                {/* Simulated App GUI */}
                <div className="w-full h-full rounded-[2rem] bg-slate-900 relative z-20 flex flex-col overflow-hidden select-none">
                  
                  {/* Simulated Mobile App Header */}
                  <div className="pt-8 pb-4 px-6 bg-slate-950 flex items-center justify-between border-b border-white/5">
                    <div className="flex items-center gap-1.5">
                      <div className="size-5 rounded-md bg-emerald-500 flex items-center justify-center text-[10px] font-black text-slate-900">G</div>
                      <span className="text-[12px] font-black tracking-tight uppercase text-white">Graminate</span>
                    </div>
                    <Icon type="notifications_active" className="text-emerald-400 !text-[16px]" />
                  </div>

                  {/* Simulated Mobile Body UI Content */}
                  <div className="p-5 flex-1 space-y-5 overflow-y-auto scrollbar-none text-white">
                    
                    {/* Live Metrics Widget */}
                    <div className="bg-slate-950 border border-white/10 rounded-2xl p-4">
                      <span className="text-[10px] uppercase font-bold text-slate-400 tracking-widest">Field Humidity</span>
                      <div className="flex items-baseline gap-2 mt-1">
                        <span className="text-2xl font-black text-emerald-400">48.2%</span>
                    ...
                    <div className="space-y-3">
                      <span className="text-xs font-bold text-slate-300">Active Tasks</span>
                      {[
                        { t: "Check Block 04 Siphon", time: "Due 10:00 AM", p: "High" },
                        { t: "Replenish Warehouse C", time: "Due 02:00 PM", p: "Medium" }
                      ].map((task, tIdx) => (
                        <div key={tIdx} className="bg-slate-950/60 border border-white/5 rounded-xl p-3 flex items-center justify-between">
                          <div>
                            <p className="text-[11px] font-bold text-white leading-none mb-1">{task.t}</p>
                            <p className="text-[9px] text-slate-400">{task.time}</p>
                          </div>
                          <span className="text-[8px] tracking-widest uppercase font-black text-emerald-400 border border-emerald-500/30 rounded px-1.5 py-0.5 bg-emerald-500/5">{task.p}</span>
                        </div>
                      ))}
                    </div>

                    {/* Analytics Chart visualization */}
                    <div className="bg-slate-950 border border-white/10 rounded-2xl p-4 h-36 flex flex-col justify-between">
                      <span className="text-[10px] uppercase font-bold text-slate-400 tracking-widest">Harvest Velocity</span>
                      {/* Mock chart bars */}
