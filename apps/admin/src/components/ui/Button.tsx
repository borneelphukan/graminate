...
const Button = ({
  ...
  const getButtonClass = (): string => {
    switch (style) {
      ...
      case "secondary":
        return "bg-white text-sm disabled:text-gray-400 disabled:bg-transparent disabled:border-gray-300 hover:bg-teal-50 text-green-200 hover:text-green-200 border border-green-200 justify-center";
      case "ghost":
