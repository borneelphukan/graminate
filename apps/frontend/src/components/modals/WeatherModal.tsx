...
const WeatherModal = ({
  ...
  const getUVRisk = (uv: number) => {
    if (uv <= 2) return { label: "Low", color: "text-green-200" };
    if (uv <= 5) return { label: "Moderate", color: "text-yellow-200" };
    if (uv <= 7) return { label: "High", color: "text-orange-200" };
    if (uv <= 10) return { label: "Very High", color: "text-red-200" };
          ...
          <div className="flex-1 overflow-hidden flex flex-col relative">
            <div className={cn(
              ...
              >
                ...
                <div className="w-1/2 flex flex-col p-6 lg:p-10 space-y-8">
                  <div className="flex flex-col lg:flex-row gap-6 w-full">
                    {/* Left Section: Main Highlights */}
                    <div className="lg:w-1/2 flex flex-col justify-center border-b lg:border-b-0 lg:border-r border-gray-400 dark:border-gray-700 pr-0 lg:pr-10 pb-6 lg:pb-0">
                    ...
                    <div className="lg:w-1/2">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {/* UV Index Card */}
                        <div className="bg-white/10 p-6 rounded-3xl border border-gray-400 dark:border-gray-700 flex flex-col hover:bg-white/15 transition-colors group">
                        ...
                        {/* Sun & Daylight Card */}
                        <div className="bg-white/10 p-6 rounded-3xl border border-gray-400 dark:border-gray-700 flex flex-col hover:bg-white/15 transition-colors">
                          <div className="flex items-center justify-between mb-4">
                            <span className="text-sm font-bold text-dark dark:text-light uppercase tracking-widest opacity-70">Daylight</span>
                          </div>
                          <div className="relative h-16 mb-2 text-dark dark:text-light">
                            <svg viewBox="0 0 160 50" className="w-full h-full overflow-visible">
                              <path
                                d="M 0 45 Q 80 5 160 45"
                                fill="none"
                                stroke="currentColor"
                                strokeOpacity="0.2"
                                strokeWidth="2"
                              ...
                              />
                              <line x1="-10" y1="45" x2="170" y2="45" stroke="currentColor" strokeOpacity="0.1" strokeWidth="1" />
                          ...
                          {/* Separate Row for Daylight Duration */}
                          <div className="text-center my-3">
                            <p className="text-xl font-black text-dark dark:text-light">{formatTime(data.daily.daylightDuration[0])}</p>
                  ...
                  {module && (
                    <div className="w-full relative overflow-hidden rounded-[2rem] border border-gray-400 dark:border-gray-700 group flex flex-col">
                      ...
                      <div className="relative z-10 p-6 flex flex-col">
                        <div className="flex items-center justify-between mb-5 shrink-0">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                              <h3 className="text-green-100 dark:text-green-300 text-xs uppercase tracking-widest">What does AI have to say ?</h3>
                              {lastFetchedAI && (
                                <span className="text-xs text-dark dark:text-light uppercase leading-none mt-1">
                        ...
                        <div className={cn("overflow-y-auto pr-2 relative", aiSuggestions || loadingAI ? "min-h-[120px]" : "min-h-0")}>
                          {plan !== "PRO" ? (
                            ...
                            <div className="animate-in fade-in slide-in-from-bottom-4 zoom-in-95 duration-1000 ease-out fill-mode-both prose prose-invert prose-green max-w-none text-dark dark:text-light/90 prose-headings:text-xs prose-headings:font-black prose-headings:uppercase prose-headings:tracking-[0.15em] prose-headings:text-green-600 dark:prose-headings:text-green-400 prose-headings:mt-4 prose-headings:mb-1 prose-p:text-sm prose-p:leading-relaxed prose-p:mb-2 prose-li:text-sm prose-li:my-1 prose-li:marker:text-green-500 prose-ul:list-disc prose-ul:pl-5 prose-strong:font-black prose-strong:text-green-600 dark:prose-strong:text-green-400 font-medium selection:bg-green-500/30">
                              <ReactMarkdown>
                                {aiSuggestions}
                              </ReactMarkdown>
                            </div>
