    ...
    return [
      ...
      },
      {
        ...
        subItems: [
          {
            label: "Marketplace",
            href: `/${userId}/settings/marketplace`,
          },
          {
              ...
              <>
                ...
                <ul className="mt-2 space-y-1">
                  {menu.subItems.map((subItem, subIndex) => {
                    let isActive = false;
                    if (
                      subItem.href === `/${userId}/settings/general/`
                    ) {
                      isActive =
