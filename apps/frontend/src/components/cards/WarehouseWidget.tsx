import { Icon, Spinner, Card, CardHeader, CardTitle, CardContent, CardDescription, CardAction } from "@graminate/ui";
...
const WarehouseWidget = ({ serviceName }: WarehouseWidgetProps) => {
  ...
  return (
    <Card className="p-4 transition-all hover:shadow-md bg-white dark:bg-gray-700">
