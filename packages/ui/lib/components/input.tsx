    ...
    return (
      ...
      >
        ...
        >
          ...
          <div
            className={`flex flex-row gap-2 items-center py-2 px-3 rounded-lg border-1 border-gray-400 dark:border-gray-200 transition-colors ${error ? "border-red-200 group-focus-within/input:!ring-red-200" : "group-focus-within/input:!ring-green-200"
          ...
          >
            ...
            <input
              className={`border-none px-0.5 flex-1 w-full text-dark focus:outline-none focus:placeholder-neutral-dark-gray dark:text-light text-sm leading-none ${options ? "[appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" : ""
                }`}
              id={id}
              name={id}
              ref={ref}
